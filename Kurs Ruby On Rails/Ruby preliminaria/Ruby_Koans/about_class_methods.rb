...
#tzw singleton_methods - metody dobudowane tylko dla konkretnego obiektu
  ...
  #metoda statyczna - albo tak, jak sie definiuje na zewnatrz klasy, albo ze slowkiem self wewnatrz
  def Dog2.wag
    :class_level_wag
  end
  ...
  # ------------------------------------------------------------------
#inny sposob na definicje metod klasowych
  class Dog
    class << self
  ...
  # 2 lepsza dla wiekszej ilosci metod klasowych, bo wymusza to ich bycie w jednym miejscu
  # ------------------------------------------------------------------
