...
CREATE ROLE test_app WITH encrypted password 'qwerty';
ALTER ROLE test_app WITH LOGIN;
GRANT CONNECT ON DATABASE student TO test_app;

GRANT INSERT, UPDATE, SELECT ON Troll, Action, Member, Index, Vote, Project TO test_app;
