...
class AboutIteration < Neo::Koan
  ...
  def test_collect_transforms_elements_of_an_array#collect == map
    array = [1, 2, 3]
...
#find - zwraca ten element z tablicy, ktory spelnia zadany warunek
    assert_equal "Clarence", array.find { |item| item.size > 4 }
  end
#inject == reduce == fold haskell!!
  def test_inject_will_blow_your_mind#w tej skladni inject(stan poczatkowy wyniku) {lambda - w niej pierwszym argumentem
  #jest nasz wynik}
