...
APP = ['{"open": {"database": "student", "login": "app", "password": "qwerty"}}',
       # poprawne dodanie akcji
       '{"protest": {"timestamp": 1557475700, "password": "123", "member": 3, "action": 500, "project": 5000, \
                    "authority": 10000}}',
       ...
       '{"support": {"timestamp": 1557475701, "password": "cztery", "member": 4, "action": 800, "project": 6000}}',
...
#       '{"votes": {"timestamp": 1557475715, "password": "abc", "member": 1, "action": 500, "project": 5001}}',
       ...
       # testy zaliczone          31556880

       # nieaktywny uzytkownik
